...
class ScrollWithListComponent extends StatefulWidget {
  final List<CategoryScrollBinder> categories;

  // WidgetBuilder pageBuilder;
  // WidgetBuilder itemBuilder;
  //constructor
  ScrollWithListComponent({Key key, @required this.categories
      // @required this.pages,
      // @required this.items,
      })
      : super(key: key);
  ...
  @override
  _ScrollWithListComponentState createState() =>
      _ScrollWithListComponentState();
}

class _ScrollWithListComponentState extends State<ScrollWithListComponent> {
